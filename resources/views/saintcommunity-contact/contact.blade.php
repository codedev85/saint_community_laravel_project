...
<body>
        ...
        <div class="contact_modal_inner">
            <div class="contact_modal__content">
                ...
                <div class="contact_modal__body">
                    ...
                    <p class="contact_modal__sub_title">
                        Use the form below to let us know how we can help you
                    </p>
                    <form action="https://formspree.io/stevedoyin@gmail.com" name="church_form" method="POST" />
                    <div class="contact_modal__input_container">
                        <label for="subject" class="contact_modal__sub_title">Subject</label>
                        <input type="text" required id="subject" name="subject" class="contact_modal__input" placeholder="Enter a Subject">
                    </div>

                    <div class="contact_modal__input_container">
                        <label for="message" class="contact_modal__sub_title">Message</label>
                        <textarea name="message" required placeholder="Message" id="message" cols="30" rows="10"></textarea>
                    </div>

                    <div class="contact_modal__input_container">
                        <label for="phone" class="contact_modal__sub_title">
                            Email
                        </label>
                        <input name="email" required class="contact_modal__input" type="email" id="phone" placeholder="Enter Phone Number">
                    </div>

                    <div class="contact_modal__input_container">
                        <label for="phone" class="contact_modal__sub_title">Phone Number</label>
                        <input name="phone" required class="contact_modal__input" type="text" id="phone" placeholder="Enter Phone Number">
                    </div>

                    <div class="contact_modal__input_container">

                        <label for="phone" class="contact_modal__sub_title">Your name</label>
                        <input type="text" required name="first-name" id="first_name" class="contact_modal__input" placeholder="First Name">
                        <br>
                        <input type="text" required name="last-name" id="last_name" class="contact_modal__input" placeholder="Last Name">

                    </div>

                    <div class="contact_modal__input_container">
                        <input class="modal__send_btn" type="submit" value="SEND">
                    </div>
    ...
    <div class="nav_menu__resp">
            <nav class="resp_menu">
                ...
                <a href="contact.html" class="resp_menu__link resp_menu__link--active">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px"
    ...
    <script src="vendors/js/mailthisto-ajax-example.js"></script>
