...
<body>
    ...
    <section style="position: relative">
        ...
        <img src="resources/images/robo.svg" class="partner__robo_first" alt="">
        <img src="resources/images/robo.svg" class="partner__robo_second" alt="">
    ...
    <div class="nav_menu__resp">
            <nav class="resp_menu">
                ...
                <a href="patnership.html" class="resp_menu__link resp_menu__link--active">
