        ...
        {{-- <nav class="nav">
            ...
            <div class="nav__inner_container main_row">
                ...
                <div class="nav__menu">
                    ...
                    <a href="program.html" class="nav__link">EVENTS</a>
...
@include('partials.nav-header')
    ...
    <section class="video_word__container">
        ...
        <img src="resources/images/robo.svg" class="third__robo" alt="">
        <img src="resources/images/robo.svg" class="fourth__robo" alt="">
        ...
        <div class="main_row">
            <div class="home_slider_container">
                <div class="home__previous">
                    <img src="resources/images/LEFT_NAV.svg" alt="">
                </div>
        ...
        <div class="featured_video__container main_row">
            ...
            <div class="featured_each_radio__container">
                ...
                <div class="featured_radio__content">
                    <img src="resources/images/video_img2.jpg" alt="">
